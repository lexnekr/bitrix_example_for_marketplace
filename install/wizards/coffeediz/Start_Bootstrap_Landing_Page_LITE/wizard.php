...
class SelectSiteStep extends CSelectSiteWizardStep
{
    function InitStep()
    {
        ...
        $wizard->solutionName = "Start_Bootstrap_Landing_Page_LITE";
...
class SiteSettingsStep extends CSiteSettingsWizardStep 
{
	...
	function InitStep()
	{
		...
		$siteSlideImg1 = "/bitrix/wizards/coffeediz/Start_Bootstrap_Landing_Page_LITE/site/templates/Start_Bootstrap_Landing_Page/img/intro-bg.jpg";
		...
		$this->content .= '<div id="wiz_content_edit_block" style="display: none;">';
			...
			<div class="wizard-input-form-block">
				<div class="wizard-metadata-title">'.GetMessage("wiz_galery_carusel").'</div>
					...
					<br/>'.CFile::ShowImage("/bitrix/wizards/coffeediz/Start_Bootstrap_Landing_Page_LITE/images/ru/galery-carusel.jpg", 600, 264, "border=0 vspace=15").'
			</div>';	
...
class FinishStep extends CFinishWizardStep
{
    ...
    function ShowStep()
    {
		...
		$this->content .= '<br/><center><a href="/bitrix/admin/composite.php?lang=ru">'.CFile::ShowImage("/bitrix/wizards/coffeediz/Start_Bootstrap_Landing_Page_LITE/images/ru/composite.gif", 600, 250, "border=0 vspace=15").'</a></center>';
