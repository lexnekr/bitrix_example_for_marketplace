...
if($wizard->GetVar("wiz_banner_carusel_switcher")=="2")
{
	...
	{
		$strNewFile = WIZARD_SITE_PATH."include/carousel/1.png";
		@copy(WIZARD_SITE_ROOT_PATH."/bitrix/wizards/coffeediz/Start_Bootstrap_Landing_Page_LITE/images/ru/carousel/1.jpg",$strNewFile);
	}
	...
	{
		$strNewFile = WIZARD_SITE_PATH."include/carousel/2.png";
		@copy(WIZARD_SITE_ROOT_PATH."/bitrix/wizards/coffeediz/Start_Bootstrap_Landing_Page_LITE/images/ru/carousel/2.png",$strNewFile);
	}
	//END Add IMG to the 1st CARUSEL slide
